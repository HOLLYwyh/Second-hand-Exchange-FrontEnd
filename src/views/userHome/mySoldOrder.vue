<template>
  <div>
    ...
    <div class="margin-style" v-if="$route.path === '/userHome/mySoldOrder'">
      <h3>我卖出的商品</h3>
...
import {cancelOrder, getSoldOrder, receiveOrder} from '../../api/order/order'
